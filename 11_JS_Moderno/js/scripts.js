...
console.log(x);
// sofreu alterção na váriavel global támbem
...
console.log(a); // não sofreu alteração na váriavel global
...
// Respeitou o escopo de bloco, ou seja, let e const respeita o escopo de bloco
...
user.sayUserName();
user.sayUserNameArrow(); // vejo o escopo atual

// 3 - Filter (método array para filtrar dados)
...
// 4 - Map (utilizado para modificar array de origem)
const products = [
...
// 6 - Destructuring desesttrutura dados complexos em várias variáveis
...
// 7 - Spread operator (usado para inserir novos valores em um array ou objeto, pode unir dois arrays)
const a1 = [1, 2, 3];
const a2 = [4, 5, 6];
